...
export class OutlookBridgeStressedError extends OutlookMcpError {
    ...
    constructor(medianMs: number, livProbeMs: number, livProbeSucceeded: boolean, operation: string) {
...
export class OutlookBridgeUnhealthyError extends OutlookMcpError {
    readonly code = ErrorCode.OUTLOOK_BRIDGE_STRESSED;
    constructor(operation: string, probeMs: number, probeSucceeded: boolean) {
...
export class MailSendIndeterminateError extends OutlookMcpError {
    readonly code = ErrorCode.MAIL_SEND_INDETERMINATE;
