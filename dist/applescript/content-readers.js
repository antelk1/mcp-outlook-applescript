 ...
 */
function readEntityDetails(dataFilePath, prefix, buildScript, parse, mapResult) {
...
export class AppleScriptEmailContentReader {
    readEmailBody(dataFilePath) {
        return readEntityDetails(dataFilePath, EMAIL_PATH_PREFIX, scripts.getMessage, parser.parseEmail, (email) => email.htmlContent ?? email.plainContent);
    }
}
...
export class AppleScriptEventContentReader {
    readEventDetails(dataFilePath) {
        return readEntityDetails(dataFilePath, EVENT_PATH_PREFIX, scripts.getEvent, parser.parseEvent, (event) => ({
            title: event.subject,
...
export class AppleScriptContactContentReader {
    readContactDetails(dataFilePath) {
        return readEntityDetails(dataFilePath, CONTACT_PATH_PREFIX, scripts.getContact, parser.parseContact, (contact) => {
...
export class AppleScriptTaskContentReader {
    readTaskDetails(dataFilePath) {
        return readEntityDetails(dataFilePath, TASK_PATH_PREFIX, scripts.getTask, parser.parseTask, (task) => ({
...
export class AppleScriptNoteContentReader {
    readNoteDetails(dataFilePath) {
        return readEntityDetails(dataFilePath, NOTE_PATH_PREFIX, scripts.getNote, parser.parseNote, (note) => {
