...
export class MailboxOrganizationTools {
    ...
    prepareEmailAction(emailId, operation, actionText) {
    ...
    prepareFolderAction(folderId, operation, actionText) {
    ...
    prepareArchiveEmail(params) {
        return this.prepareEmailAction(params.email_id, 'archive_email', 'This email will be moved to the Archive folder.');
    }
    prepareJunkEmail(params) {
        return this.prepareEmailAction(params.email_id, 'junk_email', 'This email will be moved to the Junk folder.');
    }
    prepareDeleteFolder(params) {
        return this.prepareFolderAction(params.folder_id, 'delete_folder', (folder) => `This folder and its ${folder.messageCount} messages will be deleted.`);
    }
    prepareEmptyFolder(params) {
        return this.prepareFolderAction(params.folder_id, 'empty_folder', (folder) => `All ${folder.messageCount} messages in this folder will be deleted.`);
    }
    prepareBatchDeleteEmails(params) {
        const tokens = [];
    ...
    confirmDeleteEmail(params) {
        return this.confirmEmailAction(params.token_id, 'delete_email', params.email_id, (id) => this.repository.deleteEmail(id), 'Email moved to Deleted Items.');
    }
    confirmMoveEmail(params) {
    ...
    confirmArchiveEmail(params) {
        return this.confirmEmailAction(params.token_id, 'archive_email', params.email_id, (id) => this.repository.archiveEmail(id), 'Email moved to Archive.');
    }
    confirmJunkEmail(params) {
        return this.confirmEmailAction(params.token_id, 'junk_email', params.email_id, (id) => this.repository.junkEmail(id), 'Email moved to Junk.');
    }
    confirmDeleteFolder(params) {
        return this.confirmFolderAction(params.token_id, 'delete_folder', params.folder_id, (id) => this.repository.deleteFolder(id), 'Folder deleted.');
    }
    confirmEmptyFolder(params) {
        return this.confirmFolderAction(params.token_id, 'empty_folder', params.folder_id, (id) => this.repository.emptyFolder(id), 'Folder emptied.');
    }
    confirmBatchOperation(params) {
        const results = [];
    ...
    consumeAndVerifyEmail(tokenId, operation, emailId) {
    ...
    consumeAndVerifyFolder(tokenId, operation, folderId) {
...
export function createMailboxOrganizationTools(repository, tokenManager) {
